...
#define STRING_CONFIG_H_AUTHOR "(Dibbs, 1.0)" // Who made the changes.
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 95.70
  #define DEFAULT_bedKi 18.84
  #define DEFAULT_bedKd 121.51
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 79.765, 79.765, 399.2904, 408.1 }
 ...
 */
#define DEFAULT_ACCELERATION          150 //250-500 o:1000   // X, Y, Z and E acceleration for printing moves
#define DEFAULT_RETRACT_ACCELERATION  10000    // E acceleration for retracts
#define DEFAULT_TRAVEL_ACCELERATION   600 //o: 1500    // X, Y, Z acceleration for travel (non printing) moves
 ...
 */
#define DEFAULT_XJERK                  5 // 7.5-10 o:10
#define DEFAULT_YJERK                  5 // 7.5-10 o:10
#define DEFAULT_ZJERK                  0.4 // o:.4
#define DEFAULT_EJERK                  5.0 // o:5.0
...
#define Z_PROBE_OFFSET_FROM_EXTRUDER -0.92  // Z offset: -below +above  [the nozzle] // -.83 -.79 -.74
// 
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define LEFT_PROBE_BED_POSITION MIN_PROBE_EDGE - X_PROBE_OFFSET_FROM_EXTRUDER - 20
  #define RIGHT_PROBE_BED_POSITION (X_BED_SIZE - MIN_PROBE_EDGE + X_PROBE_OFFSET_FROM_EXTRUDER) // 10 mm extra travel on x
